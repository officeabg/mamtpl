...
export const avatar3 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
  ...
  <img src="../../../assets/images/faces/2.jpg" alt="img" />
  <a href="#!" className="badge bg-success rounded-pill avatar-badge">
    <i className="fe fe-camera"></i>
  </a>
  </span>
  <span className="avatar avatar-sm me-2 avatar-rounded">
  <img src="../../../assets/images/faces/3.jpg" alt="img" />
  <a href="#!" className="badge rounded-pill bg-secondary avatar-badge">
    <i className="fe fe-edit"></i>
  </a>
  </span>
  <span className="avatar avatar-md me-2 avatar-rounded">
  <img src="../../../assets/images/faces/14.jpg" alt="img" />
  <a href="#!" className="badge rounded-pill bg-warning avatar-badge">
    <i className="fe fe-plus"></i>
  </a>
  </span>
  <span className="avatar avatar-lg me-2 avatar-rounded">
  <img src="../../../assets/images/faces/13.jpg" alt="img" />
  <a href="#!" className="badge rounded-pill bg-info avatar-badge">
    <i className="fe fe-edit"></i>
  </a>
  </span>
  <span className="avatar avatar-xl me-2 avatar-rounded">
  <img src="../../../assets/images/faces/15.jpg" alt="img" />
  <a href="#!" className="badge rounded-pill bg-success avatar-badge">
    <i className="fe fe-camera"></i>
  </a>
  </span>
  <span className="avatar avatar-xxl me-2 avatar-rounded">
  <img src="../../../assets/images/faces/9.jpg" alt="img" />
  <a href="#!" className="badge rounded-pill bg-danger avatar-badge">
    <i className="fe fe-plus"></i>
  </a>
  </span>
// End Prism Code//`;
