...
// Total Deals
export const Totaldeals: spark3= {
    series: [{
        data: [0, 32, 18, 58]
    }],
    options: {
...
export const Conversionratio: spark3= {
    series: [{
        data: [0, 32, 18, 58]
    }],
    options: {
...
export const Contactsbysource: spark3= {
...
export const Leadsbysource: spark3= {
    series: [
        {
            name: 'Actual',
            data: [
...
export const Totalearnings1: spark3= {
    series: [{
        name: 'Profit',
...
export const Totalearnings2: spark3= {
    series: [{
        name: 'Profit',
