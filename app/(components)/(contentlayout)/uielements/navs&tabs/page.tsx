...
return (
    <Fragment>
                {/* Page Header */}
                    <Seo title={"Navs & Tabs"} />
                    <Pageheader Heading="Navs & Tabs" Pages={[{title:"Ui Elements", active:true},{title:"Navs & Tabs", active:false}]} />
                {/* Page Header Close */}
                    ...
                    <Col xl={12}>
                        <Card className="custom-card">
                            ...
                            <Card.Body>
                                <Tab.Container defaultActiveKey="first">
                                    <nav>
                                        <Nav variant="pills" className="nav nav-tabs nav-justified tab-style-4 d-sm-flex d-block" id="myTab2" role="tablist" defaultActiveKey="first">
                ...
                <Row>
                    ...
                    <Col xl={12}>
                        <Card className="custom-card">
                            ...
                            <Card.Body>
                                <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                                    <Nav className="nav nav-tabs mb-3 tab-style-8 scaleX" id="myTab4" role="tablist">
                                        <Nav.Item className="nav-item" role="presentation">
                                            <Nav.Link eventKey="first" className="nav-link" id="home-style8-tab" data-bs-toggle="tab"
                                        ...
                                        <Nav.Item className="nav-item" role="presentation">
                                            <Nav.Link eventKey="second" className="nav-link" id="about-style8-tab" data-bs-toggle="tab"
                                        ...
                                        <Nav.Item className="nav-item" role="presentation">
                                            <Nav.Link eventKey="third" className="nav-link" id="services-style8-tab" data-bs-toggle="tab"
                                    ...
                                    <Tab.Content id="myTabContent3">
                                        <Tab.Pane  eventKey="first" className="overflow-hidden" id="home-style8-tab-pane"
                                            role="tabpanel" aria-labelledby="home-style8-tab" tabIndex={0}>
                                            when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                                        </Tab.Pane>
                                        <Tab.Pane  eventKey="second" className=" overflow-hidden" id="about-style8-tab-pane" role="tabpanel"
                                        ...
                                        <Tab.Pane  eventKey="third" className=" overflow-hidden" id="services-style8-tab-pane" role="tabpanel"
