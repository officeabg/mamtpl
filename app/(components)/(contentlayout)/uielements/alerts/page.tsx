"use client"
import { alert1, alert10, alert11, alert12, alert13, alert14, alert15, alert16, alert17, alert2, alert3, alert4, alert5, alert6, alert7, alert8, alert9 } from "@/shared/data/prism/uielementsprism";
import { Additionalcontentalerts, Customizedalert1, Defaultalerts, Defaultsolidalerts, Imagealerts, Linkalerts, Outlinealerts, Roundedefaultalerts, Roundedoutlinealerts, Roundedsolidalerts, Roundewithbtnalerts, Shadowsolidalerts, Solidalerts, Svgalert, Svgalert1, avatarsizealert } from "@/shared/data/uielements/alertsdata";
...
<Fragment>
           {/* Page Header */}
                <Seo title={"Alerts"} />
                <Pageheader Heading="Alerts" Pages={[{title:"Ui Elements", active:true},{title:"Alerts", active:false}]} />
            {/* Page Header Close */}

                    {/*ROW-START*/}
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Basic Alert" customCardClass="custom-card" code={alert1}>
                        ...
                        <Col xl={12}>	
                                <ShowCode title="Live example" customCardClass="custom-card" code={alert2}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Outline Alerts" customCardClass="custom-card" code={alert3}>
                        ...
                        <Col xl={12}>
                                <ShowCode title="Solid Colored Alerts" customCardClass="custom-card" code={alert8}>
                                        {solidalert.map((idx) => (
                        ...
                        <Col xl={12}>
                            <ShowCode title="Rounded Solid Alerts" customCardClass="custom-card" code={alert9}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Rounded Outline Alerts" customCardClass="custom-card" code={alert10}>
                                {roundedoutlinealert.map((idx) => (
                                    <Alert variant={idx.class} className="alert rounded-pill alert-dismissible fade show" key={Math.random()}>
                                        {idx.text}
                                        <Button variant='' type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"
                        ...
                        <Col xl={12}>
                            <ShowCode title="Rounded Default Alerts" customCardClass="custom-card" code={alert11}>
                        ...
                        <Col xl={12}>
                                <ShowCode title="Rounded Alerts With Custom Close Button" customCardClass="custom-card" code={alert12}>
                        ...
                        <Col xl={12}>
                                <ShowCode title="Customized Alerts With SVG's" customCardClass="custom-card" code={alert13}>
                        ...
                        <Col xl={12}>
                                <ShowCode title="Alerts with icons" customCardClass="custom-card" code={alert14}>
                        ...
                        <Col xl={12}>
                        <ShowCode title="Alerts With Images" customCardClass="custom-card" code={alert15}>
                                {imagesalert.map((idx) => (
                        ...
                        <Col xl={12}>
                            <ShowCode title="Alerts With Different size Images" customCardClass="custom-card" code={alert16}>
                                {avataralert.map((idx) => (
                        ...
                        <Col xl={12}>
                                    <ShowCode title="Additional content" customCardClass="custom-card" code={alert17}>
                                            <Row className="gy-3">
                                            ...
                                            <Alert variant={`solid-${idx.color}`} className={`alert  border border-${idx.color} mb-0 p-2`}>
                                                <div className="d-flex align-items-start">
                                                    <div className="me-2 svg-white">
                                                        <svg className="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" height="1.5rem"
                                                    ...
                                                    <div className="text-fixed-white w-100">
                                                        ...
                                                        <div className="fs-12">
                                                            <Link scroll={false} href="#!" className="text-fixed-white fw-semibold me-2 op-7">{idx.btn1}</Link>
                                    ...
                                    <div className="card bg-white border-0">
                                        <Alert variant='primary' className="alert custom-alert1" show={show1}>
                                            ...
                                            <div className="text-center px-5 pb-0 svg-primary">
                                                <svg className="custom-alert-icon" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000">
