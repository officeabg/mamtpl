...
import { CustomProgress2data, Multipleprogress } from "@/shared/data/uielements/progresssbardata";
...
return (
    <Fragment>
                 {/* Page Header */}
                    <Seo title={"Progress"} />
                    <Pageheader Heading="Progress" Pages={[{title:"Ui Elements", active:true},{title:"Progress", active:false}]} />
                 {/* Page Header Close */}
                    ...
                    <Row>
                        <Col xl={12}>
                                <ShowCode title="Progress With Labels" customCardClass="custom-card" customCardBodyClass="" code={progress5}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Multiple bars With Sizes" customCardClass="custom-card" customCardBodyClass="progress-body" code={progress6}>
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Animated Stripped Progress" customCardClass="custom-card" customCardBodyClass="" code={progress7}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Gradient Progress" customCardClass="custom-card" customCardBodyClass="" code={progress8}>
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Custom Progress-2" customCardClass="custom-card" customCardBodyClass="progress-body" code={progress11}>
