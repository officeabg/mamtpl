...
import { Button, Card, Col, Collapse, Dropdown, Modal, Row } from "react-bootstrap";
...
return (
    <Fragment>
                    {/* Page Header */}
                        <Seo title={"Cards"} />
                        <Pageheader Heading="Cards" Pages={[{title:"Ui Elements", active:true},{title:"Cards", active:false}]} />
                    {/* Page Header Close */}
                    ...
                    <Row>
                        <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    <h6 className="card-title fw-medium">Card title</h6>
                        ...
                        <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    <h6 className="card-title fw-medium">Card title</h6>
                                    <p className="card-text text-muted">when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic.</p>
                        ...
                        <Col xxl={6} xl={6} lg={12}>
                            ...
                            <div className="row row-cols-12">
                                <div className="col">
                                    <Card className="custom-card">
                                        <Card.Body>
                                            <img src="../../assets/images/media/media-25.jpg" className="card-img mb-3" alt="..." />
                                ...
                                <div className="col">
                                    <Card className="custom-card">
                                        <Card.Body>
                                            <img src="../../assets/images/media/media-26.jpg" className="card-img mb-3" alt="..." />
                                ...
                                <div className="col">
                                    <Card className="custom-card">
                                        <Card.Body>
                                            <img src="../../assets/images/media/media-27.jpg" className="card-img mb-3" alt="..." />
                    ...
                    <Row>
                        <Col xl={3}>
                            <Card className="card custom-card text-center">
                                ...
                                <div className="card-body pt-1">
                                    ...
                                    <div className="fw-medium fs-16">Sasha Max</div>
                        ...
                        <Col xl={3}>
                            <Card className="custom-card text-center">
                                ...
                                <Card.Body>
                                    ...
                                    <Link scroll={false} href="#!" className="btn btn-primary mt-2 me-2">Read More</Link>
                                    <Link scroll={false} href="#!" className="btn btn-outline-secondary mt-2">Close</Link>
                                </Card.Body>
                        ...
                        <Col xl={2}>
                            <Card className="custom-card">
                                <Card.Body>
                                    <img src="../../assets/images/media/media-4.jpg" className="card-img mb-3" alt="..." />
                        ...
                        <Col xl={2}>
                            <Card className="custom-card">
                                <Card.Body>
                                    <img src="../../assets/images/media/media-9.jpg" className="card-img mb-3" alt="..." />
                        ...
                        <Col xl={2}>
                            <Card className="custom-card">
                                <Card.Body>
                                    <img src="../../assets/images/media/media-15.jpg" className="card-img mb-3" alt="..." />
                        ...
                        <Col xl={4}>
                            <Card className="custom-card">
                                <div className="card-header justify-content-between border-bottom-0">
                                    ...
                                    <Link scroll={false} href="#!" data-bs-toggle="collapse" onClick={BasicHandleExpandClick}  data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                    ...
                    <Row>
                            ...
                            <Row>
                                <Col xl={6}>
                                    <Card className="custom-card w-75">
                                        ...
                                        <Card.Footer>
                                            <Link scroll={false} href="#!" className="btn btn-primary d-grid">Button</Link>
                                        </Card.Footer>
                                    </Card>
                                </Col>
                                <Col xl={6}>
                        ...
                        <Col xxl={6} xl={12}>
                            ...
                            <Row>
                                <Col xl={6}>
                                    <Card className="custom-card text-center">
                                        <Card.Header className="card-header p-4 pt-3 ps-2">
                                            <ul className="nav nav-tabs card-header-tabs ms-1">
                                                <li className="nav-item">
                                                    <Link scroll={false} className="nav-link active" aria-current="true" href="#!">Active</Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link scroll={false} className="nav-link" href="#!">Link</Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link scroll={false} href="#!" className="nav-link disabled">Disabled</Link>
                                                </li>
                                            </ul>
                                        </Card.Header>
                                        <Card.Body>
                                    ...
                                    <Card className="text-center custom-card">
                                        <Card.Header>
                                            <ul className="nav nav-pills card-header-pills ms-1">
                                                <li className="nav-item">
                                                    <Link scroll={false} className="nav-link active" href="#!">Active</Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link scroll={false} className="nav-link" href="#!">Link</Link>
                                                </li>
                                ...
                                <Card.Body>
                                    <div className="d-flex align-items-center w-100">
                                        ...
                                        <div className="ms-auto">
                                            <Link scroll={false} href="#!" className="text-fixed-white"><i className="bi bi-three-dots-vertical"></i></Link>
                                        </div>
                                    </div>
                                </Card.Body>
                            </Card>
                            ...
                            <Card className="custom-card card-bg-secondary">
                                <Card.Body>
                                    <div className="d-flex align-items-center w-100">
                                        ...
                                        <div className="">
                                            <div className="fs-15 fw-medium">Elisha Corner</div>
                            ...
                            <Card className="custom-card card-bg-warning">
                                <Card.Body>
                                    <div className="d-flex align-items-center w-100">
                                        ...
                                        <div className="">
                                            <div className="fs-15 fw-medium">Sarah Alina</div>
                            ...
                            <Card className="custom-card card-bg-info">
                                <Card.Body>
                                    <div className="d-flex align-items-center w-100">
                                        ...
                                        <div className="">
                                            <div className="fs-15 fw-medium">Monica Karen</div>
                            ...
                            <Card className="custom-card card-bg-danger">
                                <Card.Body>
                                    <div className="d-flex align-items-center w-100">
                                        ...
                                        <div className="">
                                            <div className="fs-15 fw-medium">Sebastien steyn</div>
                            ...
                            <Card className="custom-card card-bg-light">
                                <Card.Body>
                                    <div className="d-flex align-items-center w-100">
                                        ...
                                        <div className="">
                                            <div className="fs-15 fw-medium">Jacob Smith</div>
                                            <p className="mb-0 text-muted op-7 fs-12">Finished by 24,Nov</p>
                                        </div>
                                        <div className="ms-auto">
                                            <Link scroll={false} href="#!" className="text-default"><i className="bi bi-three-dots-vertical"></i></Link>
                                        </div>
                                    </div>
                                </Card.Body>
                            </Card>
                            ...
                            <Card className="custom-card card-bg-dark">
                                <Card.Body>
                                    <div className="d-flex align-items-center w-100">
                                        ...
                                        <div className="">
                                            <div className="fs-15 fw-medium text-white">Pope Adam</div>
                                            <p className="mb-0 op-7 fs-12 text-white">Completed on 24,may</p>
                                        </div>
                                        <div className="ms-auto">
                                            <Link scroll={false} href="#!" className="text-white"><i className="bi bi-three-dots-vertical"></i></Link>
                                        </div>
                                    </div>
                                </Card.Body>
                            </Card>
                    ...
                    <Row>
                        <Col xl={3}>
                            <Card className="border border-primary custom-card">
                                <Card.Body>
                                    <p className="fs-14 fw-medium mb-2 lh-1">Home Page Design
                                        <Link scroll={false} href="#!"><i className="bi bi-plus-square float-end text-primary fs-18"></i></Link>
                                    </p>
                        ...
                        <Col xl={3}>
                            <Card className="border border-secondary custom-card">
                                <Card.Body>
                                    <p className="fs-14 fw-medium mb-2 lh-1">Landing Page Design
                                        <Link scroll={false} href="#!"><i className="bi bi-plus-square float-end text-secondary fs-18"></i></Link>
                                    </p>
                                    <div className="d-flex flex-wrap gap-2 mb-4">
                        ...
                        <Col xl={3}>
                            <Card className="border border-warning custom-card">
                                <Card.Body>
                                    <p className="fs-14 fw-medium mb-2 lh-1">Update New Project
                                        <Link scroll={false} href="#!"><i className="bi bi-plus-square float-end text-warning fs-18"></i></Link>
                                    </p>
                                    <div className="d-flex flex-wrap gap-2 mb-4">
                        ...
                        <Col xl={3}>
                            <Card className="border border-info custom-card">
                                <Card.Body>
                                    <p className="fs-14 fw-medium mb-2 lh-1">New Project Discussion
                                        <Link scroll={false} href="#!"><i className="bi bi-plus-square float-end text-info fs-18"></i></Link>
                                    </p>
                                    <div className="d-flex flex-wrap gap-2 mb-4">
                                        <span className="badge bg-info-transparent">React</span>
                        ...
                        <Col xl={3}>
                            <Card className="border border-danger custom-card">
                                <Card.Body>
                                    <p className="fs-14 fw-medium mb-2 lh-1">Recent Projects Testing
                                        <Link scroll={false} href="#!"><i className="bi bi-plus-square float-end text-danger fs-18"></i></Link>
                                    </p>
                                    <div className="d-flex flex-wrap gap-2 mb-4">
                        ...
                        <Col xl={3}>
                            <Card className="border border-success custom-card">
                                <Card.Body>
                                    <p className="fs-14 fw-medium mb-2 lh-1">About Us Page redesign
                                        <Link scroll={false} href="#!"><i className="bi bi-plus-square float-end text-success fs-18"></i></Link>
                                    </p>
                                    <div className="d-flex flex-wrap gap-2 mb-4">
                        ...
                        <Col xl={3}>
                            <Card className="border border-light custom-card">
                                <Card.Body>
                                    <p className="fs-14 fw-medium mb-2 lh-1">New Employees
                                        <Link scroll={false} href="#!"><i className="bi bi-plus-square float-end text-default fs-18"></i></Link>
                                    </p>
                                    <div className="d-flex flex-wrap gap-2 mb-4">
                                        <span className="badge bg-warning-transparent">Html</span>
                        ...
                        <Col xl={3}>
                            <Card className="border border-dark custom-card">
                                <Card.Body>
                                    <p className="fs-14 fw-medium mb-2 lh-1">Terminated Employees
                                        <Link scroll={false} href="#!"><i className="bi bi-plus-square float-end text-dark fs-18"></i></Link>
                                    </p>
                                    <div className="d-flex flex-wrap gap-2 mb-4">
                        ...
                        <Col xl={12}>
                            <div className="card-group">
                                <Card className="custom-card">
                                    ...
                                    <Card.Body>
                                        <h6 className="card-title fw-medium">Delecious food is a blessing!</h6>
                                ...
                                <Card className="custom-card">
                                    ...
                                    <Card.Body>
                                        <h6 className="card-title fw-medium">Writing is an art.</h6>
                                        <p className="card-text">This is a wider card with supporting text below as
                                            a
                                ...
                                <Card className="custom-card">
                                    ...
                                    <Card.Body>
                                        <h6 className="card-title fw-medium">Is office the best place to earn knowledge?</h6>
                    ...
                    <Row>
                        <Col xl={12}>
                            <div className="row row-cols-1 row-cols-md-4 g-4">
                                <div className="col">
                                    <Card className="custom-card">
                                        <img src="../../assets/images/media/media-44.jpg" className="card-img-top" alt="..." />
                                        <Card.Body>
                                ...
                                <div className="col">
                                    <Card className="custom-card">
                                        <img src="../../assets/images/media/media-43.jpg" className="card-img-top" alt="..." />
                                        <Card.Body>
                                ...
                                <div className="col">
                                    <Card className="custom-card">
                                        <img src="../../assets/images/media/media-45.jpg" className="card-img-top" alt="..." />
                                        <Card.Body>
                                ...
                                <div className="col">
                                    <Card className="custom-card">
                                        <img src="../../assets/images/media/media-46.jpg" className="card-img-top" alt="..." />
                                        <Card.Body>
                    ...
                    <Row>
                        <Col xxl={3} xl={12} className="">
                            <Card className="custom-card">
                                ...
                                <img src="../../assets/images/media/media-23.jpg" className="card-img-top" alt="..." />
                                <Card.Body>
                                    <h6 className="card-title fw-medium mb-0">Forests are Awesome.</h6>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col xxl={6} xl={6}>
                                ...
                                <Col xxl={7} xl={12}>
                                    <Card className="custom-card">
                                        ...
                                        <div className="row g-0">
                                            ...
                                            <Col md={4}>
                                                <img src="../../assets/images/media/media-39.jpg" className="img-fluid rounded-sm-end rounded-bottom h-100 w-100" alt="..." />
                                            </Col>
                                        </div>
                                    </Card>
                                </Col>
