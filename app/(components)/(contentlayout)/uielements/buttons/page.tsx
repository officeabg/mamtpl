"use client"
import { buttons1, buttons10, buttons11, buttons12, buttons13, buttons14, buttons15, buttons16, buttons17, buttons18, buttons19, buttons2, buttons20, buttons21, buttons22, buttons23, buttons24, buttons25, buttons3, buttons4, buttons5, buttons6, buttons7, buttons8, buttons9 } from "@/shared/data/prism/uielementsprism";
import React, { Fragment } from "react";
import { Button, Col, Row } from "react-bootstrap";
import { ColoredButtons, DefaultButtons, GhostButtons, GradientButtons, LightButtons, OutlineButtons, SocialIconButtons } from "../../../../../shared/data/uielements/buttonsadata";
...
return(
    <Fragment>
            {/* Page Header */}
                <Seo title={"Buttons"} />
                <Pageheader Heading="Buttons" Pages={[{title:"Ui Elements", active:true},{title:"Buttons", active:false}]} />
            {/* Page Header Close */}

                {/*ROW-START*/}
                <Row>
                    <Col xl={12}>
                            <ShowCode title="Default Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons1}>
                    ...
                    <Col xl={12}>
                            <ShowCode title="Rounded Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons2}>
                                    <div className="btn-list">
                                        {DefaultButtons.map((idx) => (
                    ...
                    <Col xl={12}>
                            <ShowCode title="Light Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons3}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="Light Rounded Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons4}>
                                    <div className="btn-list">
                                        {LightButtons.map((idx) => (
                    ...
                    <Col xl={12}>
                            <ShowCode title="Outline Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons5}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="Rounded Outline Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons6}>
                                    <div className="btn-list">
                                        {OutlineButtons.map((idx) => (
                                            <Button type="button" variant={idx.class} className="btn rounded-pill btn-wave me-2" key={Math.random()}>{idx.text}</Button>
                                        ))}
                    ...
                    <Col xl={12}>
                            <ShowCode title="Gradient Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons7}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="Rounded Gradient Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons8}>
                                    <div className="btn-list">
                                        {GradientButtons.map((idx) => (
                                            <Button type="button" variant={idx.class} className="btn rounded-pill btn-wave me-2" key={Math.random()}>{idx.text}</Button>
                                        ))}
                    ...
                    <Col xl={12}>
                            <ShowCode title="Ghost Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons9}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="Button tags" customCardClass="custom-card" customCardBodyClass="" code={buttons10}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="disabled state with anchor tags" customCardClass="custom-card" customCardBodyClass="" code={buttons11}>
                                    <div className="btn-list">
                                        <div className="mb-4">
                    ...
                    <Col xl={12}>
                            <ShowCode title="button plugin toggle states" customCardClass="custom-card" customCardBodyClass="" code={buttons12}>
                                    <div className="btn-list">
                                        <div className="mb-4">
                    ...
                    <Col xl={12}>
                            <ShowCode title=" Link functionally caveat" customCardClass="custom-card" customCardBodyClass="" code={buttons13}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="Loading Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons14}>
                    ...
                    <Col xl={12}>
                            <ShowCode title="Icon Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons15}>
                    ...
                    <Col xl={12}>
                        <ShowCode title="Icon Button Sizes" customCardClass="custom-card" customCardBodyClass="" code={buttons16}>
                                <div className="btn-list d-md-flex d-block">
                                        <div className="mb-md-0 mb-2">
                    ...
                    <Col xl={12}>
                            <ShowCode title=" Social Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons17}>
                                    {SocialIconButtons.map((idx) => (
                                        <Button variant={idx.class} className="btn btn-icon btn-wave waves-effect waves-light m-1" key={Math.random()}>
                                            <i className={`ri-${idx.icon}-line`}></i>
                                        </Button>
                                    ))}
							</ShowCode>
                    </Col>
                    <Col xl={12}>
                        <Row>
                            <Col xl={12}>
                                <ShowCode title="Sizes" customCardClass="custom-card" customCardBodyClass="" code={buttons18}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                        <Row>
                            <Col xl={12}>
                            <ShowCode title="Button Widths" customCardClass="custom-card" customCardBodyClass="" code={buttons19}>
                                <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="Buttons With Different Shadows" customCardClass="custom-card" customCardBodyClass="" code={buttons20}>
                    ...
                    <Col xl={12}>
                            <ShowCode title="Different Colored Buttons With Shadows" customCardClass="custom-card" customCardBodyClass="" code={buttons21}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                        <ShowCode title="Raised Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons22}>
                                <div className="btn-list">
                                    {ColoredButtons.map((idx) => (
                    ...
                    <Col xl={12}>
                            <ShowCode title="Label Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons23}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="Custom Buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons24}>
                                    <div className="btn-list">
                    ...
                    <Col xl={12}>
                            <ShowCode title="Block buttons" customCardClass="custom-card" customCardBodyClass="" code={buttons25}>
                                    <div className="btn-list">
