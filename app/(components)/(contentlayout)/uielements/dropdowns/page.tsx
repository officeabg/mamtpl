"use client"
import { dropdown1, dropdown10, dropdown11, dropdown12, dropdown13, dropdown14, dropdown15, dropdown16, dropdown17, dropdown18, dropdown19, dropdown2, dropdown20, dropdown21, dropdown22, dropdown23, dropdown24, dropdown25, dropdown26, dropdown27, dropdown28, dropdown29, dropdown3, dropdown4, dropdown5, dropdown6, dropdown7, dropdown8, dropdown9 } from "@/shared/data/prism/uielementsprism";
import { GhostButtons, OutlineButtons } from "@/shared/data/uielements/buttonsadata";
import { AlignmentButtons, AutocloseButtons, CustomButtons, SingleButtons, SplitButtonsdata } from "@/shared/data/uielements/dropdownsdata";
...
return(
    <Fragment>
                   {/* Page Header */}
                        <Seo title={"Dropdowns"} />
                        <Pageheader Heading="Dropdowns" Pages={[{title:"Ui Elements", active:true},{title:"Dropdowns", active:false}]} />
                    {/* Page Header Close */}
                    ...
                    <Row>
                        ...
                        <Col xl={6}>
                                <ShowCode title="Active" customCardClass="custom-card" customCardBodyClass="" code={dropdown10}>
                                    <Dropdown>
                                        <Dropdown.Toggle variant='' type="button" className="btn btn-primary dropdown-toggle"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            Dropstart
                        ...
                        <Col xl={6}>
                                <ShowCode title="Dropup left" customCardClass="custom-card" customCardBodyClass="" code={dropdown11}>
                    ...
                    <Row>
                        ...
                        <Col xl={12}>
                                <ShowCode title="Responsive alignment end" customCardClass="custom-card" customCardBodyClass="" code={dropdown22}>
                                    <div className="btn-group">
                        ...
                        <Col xl={12}>
                                <ShowCode title="Responsive alignment left" customCardClass="custom-card" customCardBodyClass="" code={dropdown23}>
                                    <div className="btn-group">
