"use client"
import { pagination1, pagination2, pagination3, pagination4, pagination5, pagination6, pagination7, pagination8, pagination9 } from "@/shared/data/prism/uielementsprism";
...
return (
    <Fragment>
                {/* Page Header */}
                    ...
                    <Pageheader Heading="Pagination" Pages={[{title:"Ui Elements", active:true},{title:"Pagination", active:false}]} />
                {/* Page Header Close */}
