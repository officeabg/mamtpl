"use client"
import { toast1, toast10, toast2, toast3, toast4, toast5, toast6, toast7, toast8, toast9 } from "@/shared/data/prism/uielementsprism";
import { Customtoaster } from "@/shared/data/uielements/toastdata";
import Pageheader from "@/shared/layout-components/page-header/pageheader";
import Seo from "@/shared/layout-components/seo/seo";
import ShowCode from "@/shared/layout-components/showcode/showcode";
import React, { Fragment, useState } from "react";
import { Button, Card, CloseButton, Col, Row, Toast, ToastContainer } from "react-bootstrap";
...
return (
    <Fragment>
                    {/* Page Header */}
                        <Seo title={"Toasts"} />
                        <Pageheader Heading="Toasts" Pages={[{title:"Ui Elements", active:true},{title:"Toasts", active:false}]} />
                    {/* Page Header Close */}

                    {/* Start:: row-1 */}
                    <Row>
                        <Col xl={12}>
                                <ShowCode title="Live example" customCardClass="custom-card" customCardBodyClass="" code={toast1}>
                                    ...
                                    <ShowCode title=" Color schemes" customCardClass="custom-card" customCardBodyClass="" code={toast2}>
                        ...
                        <Col xl={12}>
                                <ShowCode title="Basic example" customCardClass="custom-card" customCardBodyClass="" code={toast3}>
                                    ...
                                    <ShowCode title="Stacking" customCardClass="custom-card" customCardBodyClass="" code={toast4}>
                        ...
                        <Col xl={12}>
                                <ShowCode title="Translucent" customCardClass="custom-card" customCardBodyClass="" code={toast5}>
                                ...
                                <ShowCode title="Custom content" customCardClass="custom-card" customCardBodyClass="" code={toast6}>
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Color Variants Live" customCardClass="custom-card" customCardBodyClass="" code={toast7}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Solid Background Toasts" customCardClass="custom-card" customCardBodyClass="" code={toast8}>
                                <div className="btn-list">
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Toast Placements" customCardClass="custom-card" customCardBodyClass="" code={toast9}>
                                <div className="btn-list">
                            ...
                            <div className="bd-example bg-light bd-example-toasts d-flex p-0">
                                <div aria-live="polite" aria-atomic="true"
                                    ...
                                    <Toast show={showK} onClose={toggleShowK}  className="toast fade show shadow-lg" role="alert" aria-live="assertive"
                                                aria-atomic="true">
                                        <Toast.Header className="text-default">
                                        <img className="bd-placeholder-img rounded me-2" src="../../assets/images/brand-logos/toggle-logo.png" alt="..." />
                                            <strong className="me-auto">Mamix</strong>
                                            <small>11 mins ago</small>
                                        </Toast.Header>
                                        <Toast.Body> Hello, world! This is a toast message.</Toast.Body>
