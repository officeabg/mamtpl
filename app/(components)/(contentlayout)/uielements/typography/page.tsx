...
return (
    <Fragment>
                    {/* Page Header */}
                         ...
                         <Pageheader Heading="Typography" Pages={[{title:"Ui Elements", active:true},{title:"Typography", active:false}]} />
                    {/* Page Header Close */}
                    ...
                    <Row>
                        <Col xl={12}>
                                <ShowCode title="Left Aligned" customCardClass="custom-card" customCardBodyClass="" code={typography8}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Right Aligned" customCardClass="custom-card" customCardBodyClass="" code={typography9}>
                    ...
                    <Row>
                        <Col xl={6}>
                            <ShowCode title="Primary Blockquote" customCardClass="custom-card" customCardBodyClass="" code={typography10}>
                        ...
                        <Col xl={6}>
                            <ShowCode title="Secondary Blockquote" customCardClass="custom-card" customCardBodyClass="" code={typography11}>
                        ...
                        <Col xl={6}>
                            <ShowCode title="Warning Blockquote" customCardClass="custom-card" customCardBodyClass="" code={typography12}>
                        ...
                        <Col xl={6}>
                            <ShowCode title=" Success Blockquote" customCardClass="custom-card" customCardBodyClass="" code={typography13}>
                        ...
                        <Col xl={6}>
                            <ShowCode title="Info Blockquote" customCardClass="custom-card" customCardBodyClass="" code={typography14}>
                        ...
                        <Col xl={6}>
                                <ShowCode title="Danger Blockquote" customCardClass="custom-card" customCardBodyClass="" code={typography15}>
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title=" Description list alignment" customCardClass="custom-card" customCardBodyClass="" code={typography16}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="List Unstyled" customCardClass="custom-card" customCardBodyClass="" code={typography17}>
                    ...
                    <Row>
                        <Col xl={6}>
                            <ShowCode title="Text transform" customCardClass="custom-card" customCardBodyClass="" code={typography21}>
                        ...
                        <Col xl={6}>
                            <ShowCode title=" Text decoration" customCardClass="custom-card" customCardBodyClass="" code={typography22}>
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Font weight and italics" customCardClass="custom-card" customCardBodyClass="" code={typography23}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Line height" customCardClass="custom-card" customCardBodyClass="" code={typography24}>
                    ...
                    <Row>
                        <Col xl={6}>
                            <ShowCode title="Monospace" customCardClass="custom-card" customCardBodyClass="" code={typography25}>
                                <p className="font-monospace mb-0">This is in monospace</p>
                            </ShowCode>
                        </Col>
                        <Col xl={6}>
                            <ShowCode title="Reset color" customCardClass="custom-card" customCardBodyClass="" code={typography26}>
                        ...
                        <Col xl={6}>
                            <ShowCode title="Visible text" customCardClass="custom-card" customCardBodyClass="" code={typography27}>
                                <p className="visible mb-0">This is visible text</p>
                            </ShowCode>
                        </Col>
                        <Col xl={6}>
                            <ShowCode title="Invisible text" customCardClass="custom-card" customCardBodyClass="" code={typography28}>
