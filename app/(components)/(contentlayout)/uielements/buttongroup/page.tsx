"use client"
import { btngroup1, btngroup10, btngroup11, btngroup2, btngroup3, btngroup4, btngroup5, btngroup6, btngroup7, btngroup8, btngroup9 } from "@/shared/data/prism/uielementsprism";
import { SocialIconButtons } from "@/shared/data/uielements/buttonsadata";
...
<Fragment>
            {/* Page Header */}
                ...
                <Pageheader Heading="Button Group" Pages={[{title:"Ui Elements", active:true},{title:"Button Group", active:false}]} />
            {/* Page Header Close */}
                        ...
                        <ShowCode title="Social Group Buttons" customCardClass="custom-card" customCardBodyClass="" code={btngroup11}>
                            <ButtonGroup className="btn-group" role="group" aria-label="Basic example">
                                {SocialIconButtons.map((idx) => (
                                    <Button variant={idx.class} className="btn btn-icon btn-wave lh-1" key={Math.random()}>
