"use client"
import { accordion1, accordion10, accordion11, accordion12, accordion13, accordion14, accordion15, accordion16, accordion2, accordion3, accordion4, accordion5, accordion6, accordion7, accordion8, accordion9 } from "@/shared/data/prism/advance-uiprism";
...
return (
    <Fragment>
                {/* Page Header */}
                    ...
                    <Pageheader Heading="Accordions" Pages={[{title:"Advanced Ui", active:true},{title:"Accordions", active:false}]} />
                {/* Page Header Close */}
                ...
                <Row>
                    ...
                    <ShowCode title="Always Open Accordion <p class='text-muted subtitle fs-12 fw-normal'>Omit the <code>data-bs-parent</code> attribute on each
									<code>.accordion-collapse</code> to make accordion items stay open when another item is opened.</p>" customCardClass="custom-card" customCardBodyClass="" code={accordion2}>
                ...
                <Row>
                    ...
                    <ShowCode title="Flush Accordion <p class='subtitle text-muted fs-12 fw-normal'>
                        ...
                        their parent container.</p>" customCardClass="custom-card" customCardBodyClass="p-0" code={accordion3}>
                ...
                <Row>
                    <Col xl={12}>
                        <ShowCode title="Primary" customCardClass="custom-card" customCardBodyClass="" code={accordion8}>
                    ...
                    <Col xl={12}>
                        <ShowCode title="Success" customCardClass="custom-card" customCardBodyClass="" code={accordion9}>
                ...
                <Row>
                    <Col xl={12}>
                        <ShowCode title="Example" customCardClass="custom-card" customCardBodyClass="" code={accordion10}>
                            <p className="mb-0">
                    ...
                    <Col xl={12}>
                        <ShowCode title="Multiple Targets Collapse" customCardClass="custom-card" customCardBodyClass="" code={accordion11}>
                            <p className="mb-0">
                ...
                <Row>
                    <Col xl={12}>
                        <ShowCode title="Custom Icon Accordion" customCardClass="custom-card" customCardBodyClass="" code={accordion12}>
                    ...
                    <Col xl={12}>
                        <ShowCode title="Custom Accordion" customCardClass="custom-card" customCardBodyClass="" code={accordion13}>
                ...
                <Row>
                    <Col xl={12}>
                            <ShowCode title="Left Aligned Icons" customCardClass="custom-card" customCardBodyClass="" code={accordion14}>
                    ...
                    <Col xl={12}>
                        <ShowCode title="Without Icon" customCardClass="custom-card" customCardBodyClass="" code={accordion15}>
