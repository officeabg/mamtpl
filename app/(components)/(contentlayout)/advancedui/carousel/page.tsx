"use client"
import { carousel1, carousel2, carousel3, carousel4, carousel5, carousel6, carousel7, carousel8 } from "@/shared/data/prism/advance-uiprism";
...
return (
    <Fragment>
                    {/* Page Header */}
                        <Seo title={"Carousel"} />
                        <Pageheader Heading="Carousel" Pages={[{title:"Advanced Ui", active:true},{title:"Carousel", active:false}]} />
                    {/* Page Header Close */}
