"use client"
import { modal1, modal10, modal11, modal12, modal13, modal14, modal15, modal2, modal3, modal4, modal5, modal6, modal7, modal8, modal9 } from "@/shared/data/prism/advance-uiprism";
...
return (
    <Fragment>
                 {/* Page Header */}
                    ...
                    <Pageheader Heading="Modal & Closes" Pages={[{title:"Advanced Ui", active:true},{title:"Modal & Closes", active:false}]} />
                 {/* Page Header Close */}
                                    ...
                                    <Modal.Body>
                                        ...
                                        <p className="mb-0">
                                            <OverlayTrigger placement="top" overlay={<Tooltip>tooltip</Tooltip>}>
                                                <Link scroll={false} href="#!" className="text-primary">This link</Link>
                                            </OverlayTrigger> and <OverlayTrigger placement="top" overlay={<Tooltip>tooltip</Tooltip>}>
                                                <Link scroll={false} href="#!" className="text-primary">that link</Link>
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Modal Animation Effects" customCardClass="custom-card" customCardHeaderClass=""  customCardBodyClass="" code={modal12}>
                                <Row className="row-sm">
                                        <Col sm={6} md={4} xl={3} className="">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("Basic")}>Zoom</Link>
                                        ...
                                        <Col sm={6} md={4} xl={3} className="mg-t-20 mg-sm-t-0">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("show2")}>Fade</Link>
                                        ...
                                        <Col sm={6} md={4} xl={3} className="mg-t-20 mg-md-t-0">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("show3")}>Flip</Link>
                                        ...
                                        <Col sm={6} md={4} xl={3} className="mg-t-20 mg-xl-t-0">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("show4")}>Door</Link>
                                        ...
                                        <Col sm={6} md={4} xl={3} className="mg-t-20">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("show5")}>Rotate</Link>
                                        ...
                                        <Col sm={6} md={4} xl={3} className="mg-t-20">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("show6")}>Slide-Up</Link>
                                        ...
                                        <Col sm={6} md={4} xl={3} className="mg-t-20">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("show7")}>slide-Down</Link>
                                        ...
                                        <Col sm={6} md={4} xl={3} className="mg-t-20">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("show8")}>slide-Left</Link>
                                        ...
                                        <Col sm={6} md={4} xl={3} className="mg-t-20">
                                            <Link scroll={false} href="#!" className="modal-effect btn btn-outline-primary w-100 btn-block mb-3" onClick={() => viewDemoShow1("show9")}>slide-Right</Link>
                    ...
                    <Row>
                        <Col xl={4}>
                            <ShowCode title="Basic Close" customCardClass="custom-card" customCardHeaderClass=""  customCardBodyClass="" code={modal13}>
                                <Button variant='' type="button" className="btn-close" aria-label="Close"></Button>
                            </ShowCode>
                        </Col>
                        <Col xl={4}>
                                <ShowCode title="Disable state" customCardClass="custom-card" customCardHeaderClass=""  customCardBodyClass="" code={modal14}>
                                    <Button variant='' type="button" className="btn-close" disabled aria-label="Close"></Button>
                                </ShowCode>
                        </Col>
                        <Col xl={4}>
                                <ShowCode title="White variant" customCardClass="custom-card overflow-hidden" customCardHeaderClass=""  customCardBodyClass="bg-black" code={modal15}>
