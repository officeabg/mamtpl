...
return (
    <Fragment>
                {/* Page Header */}
                    <Seo title={"Navbar"} />
                    <Pageheader Heading="Navbar" Pages={[{title:"Advanced Ui", active:true},{title:"Navbar", active:false}]} />
                {/* Page Header Close */}
                                            ...
                                            <Navbar.Collapse className="" id="navbarSupportedContent">
                                                <Nav as="ul" className="navbar-nav me-auto mb-2 mb-lg-0">
                                                    <Nav.Item className="mb-1">
                                                        <Nav.Link active className="active" aria-current="page" href="#!">Home</Nav.Link>
                                                    </Nav.Item>
                                                    <Nav.Item>
                            ...
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    <Navbar className="navbar bg-light mb-3">
                                        <Container fluid>
                                            <Link scroll={false} className="navbar-brand" href="#!"><img src="../../assets/images/brand-logos/toggle-logo.png" alt=""/></Link>
                                        </Container>
                                    </Navbar>
                            ...
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    ...
                                    <Navbar expand="lg" className="navbar navbar-expand-lg navbar-secondary mb-3">
                                        <Container fluid>
                                            <Navbar.Brand href='#!'>  <img src="../../assets/images/brand-logos/toggle-dark.png" alt=""/></Navbar.Brand>
                                            <Navbar.Toggle aria-controls="basic-navbar-nav" />
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    <Navbar expand={false} className="navbar bg-light fixed-top m-2">
                                        <Container fluid>
                                            <Navbar.Brand>Offcanvas navbar</Navbar.Brand>
