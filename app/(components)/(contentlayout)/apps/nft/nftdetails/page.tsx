...
return ( 
    <Fragment>
            {/* Page Header */}
                ...
                <Pageheader Heading="NFT Details" Pages={[{title:"Apps", active:true},{title:"NFT", active:true},{title:"NFT Details", active:false}]} />
            {/* Page Header Close */}
                ...
                <div className="row justify-content-center">
                    <Col xl={12}>
                        <Card className="custom-card overflow-hidden">
                            <Card.Body>
                                <span className="nft-details-auction-time shadow">48hrs : 16mins : 21sec</span>
                                        ...
                                        <Row>
                                            <Col xxl={12} sm={12} className="mb-md-5 mb-3">
                                                <Swiper loop={true}
                                                    ...
                                                    modules={[FreeMode, Navigation, Thumbs]} className="swiper-preview-details bg-light product-details-page">
                                                ...
                                                <Swiper onSwiper={setThumbsSwiper}
                                                    ...
                                                    modules={[FreeMode, Navigation, Thumbs]} className="swiper-view-details mt-2">
                                                        <SwiperSlide>
                                                            <img className="img-fluid" src="../../../assets/images/nft-images/2.jpg" alt="img" />
                                                        </SwiperSlide>
                                                        <SwiperSlide className="image-container">
                                                ...
                                                <div className="d-grid mt-4">
                                                    <Button variant="" className="btn btn-primary btn-wave">Place a bid</Button>
                                                </div>
                                            </Col>
                                            <div className="col-xxl-12 col-sm-12 d-md-block d-none">
                                                <p className="fs-15 fw-medium mb-2">Featured NFT's :</p>
                                                <div className="table-responsive overflow-hidden">
                                                    <table className="table table-bordered text-nowrap">
                                                        <tbody>
                                                                    ...
                                                                    <Link scroll={false} href="#!">
                                                                        <div className="d-flex align-items-top">
                                                                            ...
                                                                            <div className="flex-fill">
                                                                                <p className="mb-1 fs-14 fw-medium similar-product-name text-truncate">Neo-Nebulae</p>
                                                                                <p className="mb-0">
                                                                                    <span className="badge bg-success">13.2k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <Link scroll={false} href="#!">
                                                                        <div className="d-flex align-items-top">
                                                                            ...
                                                                            <div className="flex-fill">
                                                                                <p className="mb-1 fs-14 fw-medium similar-product-name text-truncate">Chromatic Chaos</p>
                                                                                <p className="mb-0">
                                                                                    <span className="badge bg-success">5.2k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <Link scroll={false} href="#!">
                                                                        <div className="d-flex align-items-top">
                                                                            ...
                                                                            <div className="flex-fill">
                                                                                <p className="mb-1 fw-medium similar-product-name text-truncate">Surreal Synthesis</p>
                                                                                <p className="mb-0">
                                                                                    <span className="badge bg-success">2.4k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <Link scroll={false} href="#!">
                                                                        <div className="d-flex align-items-top">
                                                                            ...
                                                                            <div className="flex-fill">
                                                                                <p className="mb-1 fw-medium similar-product-name text-truncate">Virtual Visions</p>
                                                                                <p className="mb-0">
                                                                                    <span className="badge bg-success">1.8k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <Link scroll={false} href="#!">
                                                                        <div className="d-flex align-items-top">
                                                                            ...
                                                                            <div className="flex-fill">
                                                                                <p className="mb-1 fw-medium similar-product-name text-truncate">Pixel Prism</p>
                                                                                <p className="mb-0">
                                                                                    <span className="badge bg-success">12.9k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <Link scroll={false} href="#!">
                                                                        <div className="d-flex align-items-top">
                                                                            ...
                                                                            <div className="flex-fill">
                                                                                <p className="mb-1 fw-medium similar-product-name text-truncate">Electric Euphoria</p>
                                                                                <p className="mb-0">
                                                                                    <span className="badge bg-success">4.5k<i className="ri-heart-3-fill align-middle ms-1"></i></span>
                                                            ...
                                                            <tr>
                                                                <td className="d-grid">
                                                                    <Button variant="" className="btn btn-secondary-light">View All NFT's</Button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <Col xxl={8} xl={12}>
                                        <div className="row gx-5">
                                            <Col xl={12} className="mt-xxl-0 mt-3">
                                                <div>
                                                    <p className="fs-18 fw-medium mb-0">Digital Dream Space - NFT Digital Art</p>
                                                    ...
                                                    <div className="row mb-4">
                                                        <Col xxl={3} xl={12} className="">
                                                            <p className="mb-1 lh-1 fs-11 text-success fw-medium">Special Offer</p>
                                                            <p className="mb-1"><span className="h3"><span className="avatar avatar-sm avatar-rounded p-1 bg-light me-2"><img src="../../../assets/images/crypto-currencies/regular/Ethereum.svg" alt="" /></span>1.299<sup className="fs-14">.00</sup></span><span className="ms-3 badge bg-danger-transparent">50% Off</span></p>
                                                            <p className="mb-0 text-muted fs-12">M.R.P-<s>ETH2,599.00</s></p>
                                                        </Col>
                                                        <Col xxl={4} xl={6} lg={6} md={6} sm={12} className="mt-xxl-0 mt-3">
                                                            <p className="mb-2 fs-15 fw-medium">Creator</p>
                                                            <div className="d-flex align-items-center fw-medium">
                                                                <span className="avatar avatar-xs avatar-rounded lh-1 me-1"><img src="../../../assets/images/faces/9.jpg" alt="" /></span>
                                                                Jack Miller
                                                            </div>
                                                        </Col>
                                                        ...
                                                        <div className="row justify-content-center">
                                                            <Col xxl={4} xl={4} lg={4} md={4} sm={4} className="col-12">
                                                                <div className="ecommerce-assurance">
                                                                    ...
                                                                    <p className="fs-14 fw-medium mb-0">Featured NFT</p>
                                                                </div>
                                                            </Col>
                                                    ...
                                                    <div className="mb-4">
                                                        <p className="fs-15 fw-medium mb-2">Product Details :</p>
                                                        <Row>
                                                            <Col xl={10}>
                                                        ...
                                                        <Row>
                                                            ...
                                                            <Col xl={6}>
                                                                <ul className="mb-0">
                                                                    ...
                                                                    <li className="text-muted">
                                                                        Exhibition History: Digital Art Expo 2024 - Gallery XYZ, New York City
                                                                    </li>
                                                                </ul>
                                                            </Col>
                                                        </Row>
                                                        ...
                                                        <Row>
                                                            <Col xxl={4} xl={12} lg={12} md={12} sm={12} className="">
                                                                ...
                                                                <div className="d-flex align-items-center mb-3">
                                                                    ...
                                                                    <ProgressBar variant="success" now={55} className="progress progress-xs flex-fill"  />
                                                                    <div className="text-muted ms-2 fs-12">(10)</div>
                                                                </div>
                                                                <div className="d-flex align-items-center mb-3">
                                                                    <div className="fs-12 me-2 fw-medium">4 <i className="ri-star-fill fs-10"></i></div>
                                                                    <ProgressBar variant="success" now={22} className="progress progress-xs flex-fill"  />
                                                                    <div className="text-muted ms-2 fs-12">(6)</div> 
                                                                </div>
                                                                <div className="d-flex align-items-center mb-3">
                                                                    <div className="fs-12 me-2 fw-medium">3 <i className="ri-star-fill fs-10"></i></div>
                                                                    <ProgressBar variant="success" now={8} className="progress progress-xs flex-fill"  />
                                                                    <div className="text-muted ms-2 fs-12">(4)</div>
                                                                </div>
                                                                <div className="d-flex align-items-center mb-3">
                                                                    <div className="fs-12 me-2 fw-medium">2 <i className="ri-star-fill fs-10"></i></div>
                                                                    <ProgressBar variant="warning" now={9} className="progress progress-xs flex-fill"  />
                                                                    <div className="text-muted ms-2 fs-12">(1)</div>
                                                                </div>
                                                                <div className="d-flex align-items-center">
                                                                    <div className="fs-12 me-2 fw-medium">1 <i className="ri-star-fill fs-10"></i></div>
                                                                    <ProgressBar variant="danger" now={6} className="progress progress-xs flex-fill"  />
                                                                    <div className="text-muted ms-2 fs-12">(1)</div>
                                                                </div>
                                                            </Col>
                                                            <Col xxl={8} xl={12} lg={12} md={12} sm={12} className="mt-xxl-0 mt-3">
                                                                <div className="border rounded p-3">
                                                                    <div className="d-sm-flex d-block align-items-top mb-3">
                                                                        <div className="d-flex flex-fill">
                                                                            ...
                                                                            <div className="lh-1 me-2">
                                                                                <p className="mb-1 fw-medium fs-14">Christopher</p>
                                                                                <div className="mb-1">
                                                                    ...
                                                                    <div className="ps-sm-4 ps-0 mb-3">
                                                                        <p className="fw-medium mb-1 ps-2">Truely amazing NFT&#128512;</p>
