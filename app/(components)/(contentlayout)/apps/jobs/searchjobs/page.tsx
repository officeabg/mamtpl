...
import { Button, Card, Col, Collapse, Dropdown, Form, OverlayTrigger, Pagination, Row, Tooltip } from "react-bootstrap";
...
return ( 
    <Fragment>
            {/* Page Header */}
                ...
                <Pageheader Heading="Search Jobs" Pages={[{title:"Apps", active:true},{title:"Jobs", active:true},{title:"Search Jobs", active:false}]} />
            {/* Page Header Close */}
                        ...
                        <Card className="custom-card products-navigation-card">
                            <Card.Body className="p-0">
                                <div className="py-4 px-sm-4 p-3 border-bottom">
                                    ...
                                    <div className="px-sm-2 px-0 py-3 pb-0">
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="c-1" checked />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="c-3" checked />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="c-4" checked />
                                ...
                                <div className="py-4 px-sm-4 p-3 border-bottom">
                                    ...
                                    <div className="px-sm-2 px-0 py-3 pb-0">
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="j-1" checked />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="j-2" checked />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="j-3" checked />
                                ...
                                <div className="py-4 px-sm-4 p-3 border-bottom">
                                    ...
                                    <div className="px-sm-2 px-0 py-3 pb-0">
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="q-2" checked />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="q-4" checked />
                                ...
                                <div className="py-4 px-sm-4 p-3 border-bottom">
                                    ...
                                    <div className="px-sm-2 px-0 py-3 pb-0">
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="e-1" checked />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="e-2" />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="e-3" checked />
                                        ...
                                        <div className="form-check">
                                            <Form.Check className="" type="checkbox" value="" id="e-4" checked />
                                ...
                                <div className="py-4 px-sm-4 p-3">
                                    ...
                                    <div className="px-sm-2 px-0 py-3 pb-0">
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="s-1" checked />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="s-2" checked />
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check className="" type="checkbox" value="" id="s-4" checked />
                                ...
                                <Card className="custom-card featured-jobs">
                                    <Card.Body>
                                        ...
                                        <OverlayTrigger placement="top" overlay={<Tooltip>Add to Wishlist</Tooltip>}>
                                            <Link scroll={false} href="#!" className="avatar avatar-rounded avatar-sm bg-light text-default" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Add to wishlist" data-bs-original-title="Add to wishlist"><span><i className="bi bi-heart"></i></span></Link>
                                        </OverlayTrigger>
                                        <OverlayTrigger placement="top" overlay={<Tooltip>Featured Jobs</Tooltip>}>
                                            <Link scroll={false} href="#!" className="avatar avatar-rounded avatar-sm bg-warning-transparent" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Featured Jobs" data-bs-original-title="Featured Jobs"><span><i className="bi bi-star-fill"></i></span></Link>
                                        </OverlayTrigger>
                                        </div>
                                        <div className="d-flex mb-3 flex-wrap gap-2 align-items-center">
                                            ...
                                            <div>
                                                <h5 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!"> HTML Developer - Fresher</Link></h5>
                                                <Link scroll={false} href="#!">Spotech Technical Solutions</Link>
                                            </div>
                                        </div> 
                                        <div className="popular-tags mb-3">
                                            ...
                                            <Link scroll={false} href="#!" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-briefcase text-muted me-1"></i> 13 Openings</Link>
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <Link scroll={false} href="#!" className="text-primary fw-medium fs-14 d-inline-flex">
                                ...
                                <Card className="custom-card featured-jobs">
                                    <Card.Body>
                                        ...
                                        <div className="d-flex mb-3 flex-wrap gap-2 align-items-center">
                                            ...
                                            <div>
                                                <h5 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!"> React Lead Developer</Link></h5>
                                                <Link scroll={false} href="#!">Infratech PVT LTD</Link>
                                            </div>
                                        </div> 
                                        <div className="popular-tags mb-3">
                                            <Link scroll={false} href="#!" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                                ...
                                <Card className="custom-card featured-jobs">
                                    <Card.Body>
                                        ...
                                        <div className="d-flex mb-3 flex-wrap gap-2 align-items-center">
                                            ...
                                            <div>
                                                <h5 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!"> Vuejs Frontend Developer</Link></h5>
                                ...
                                <Card className="custom-card featured-jobs">
                                    <Card.Body>
                                        ...
                                        <div className="d-flex mb-3 flex-wrap gap-2 align-items-center">
                                            ...
                                            <div>
                                                <h5 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!"> Wordpress Developer - Remote</Link></h5>
