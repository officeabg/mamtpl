...
return ( 
    <Fragment>
            {/* Page Header */}
                ...
                <Pageheader Heading="Job Details" Pages={[{title:"Apps", active:true},{title:"Jobs", active:true},{title:"Job Details", active:false}]} />
            {/* Page Header Close */}
                ...
                <Row>
                    <Col xl={8}>
                                ...
                                <div className="d-flex flex-wrap align-items-top justify-content-between gap-2">
                                    <div>
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h4 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!">UI Developer - Fresher</Link></h4>
                                                <Link scroll={false} href="#!" className="fw-medium"><i className="bi bi-building"></i> Spruko Technologies PRIVATE LIMITED</Link>
                                                <div className="d-flex fs-14 mt-4">
                                                    ...
                                                    <div className="ms-4">
                                                        <p className="mb-1"><i className="bi bi-coin me-1"></i><span className="fw-medium">10,000 - 20,000</span> / per month (+incentives)</p>
                                    ...
                                    <div>
                                        ...
                                        <p className="mb-0"><i className="bi bi-info-circle text-danger" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="45 days left"></i> <span className="fw-medium">45 days left </span> to apply this job</p>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                        ...
                        <div>
                            ...
                            <Swiper spaceBetween={30} centeredSlides={true} autoplay={{ delay: 2500, disableOnInteraction: false, }} navigation={true}
                                    modules={[Autoplay ,Navigation]} className="swiper-related-jobs">
                                    <SwiperSlide>
                                        <Row>
                                            <Col md={6}>
                                                    ...
                                                    <Card.Body>
                                                        <div className="btn-list float-end">
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Add to wishlist</Tooltip>}>
                                                                <Link scroll={false} href="#!" className="avatar avatar-sm avatar-rounded bg-light text-default" data-bs-placement="top">
                                                                    <span><i className="bi bi-heart"></i></span>
                                                                </Link>
                                                            </OverlayTrigger>
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Featured Jobs</Tooltip>}>
                                                                <Link scroll={false} href="#!" className="avatar avatar-sm avatar-rounded bg-warning-transparent" data-bs-placement="top" 
                                                                    aria-label="Featured Jobs" data-bs-original-title="Featured Jobs"><span><i className="bi bi-star-fill"></i></span>
                                                                </Link>
                                                            </OverlayTrigger>
                                                        </div>
                                                        <div className="d-flex mb-3 flex-wrap gap-2">
                                                            ...
                                                            <div className="ms-2">
                                                                <h5 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!"> HTML Developer</Link></h5>
                                                                <Link scroll={false} href="#!"><i className="bi bi-building"></i> Spotech Technical Solutions</Link>
                                                            </div>
                                                        </div> 
                                                        <div className="popular-tags mb-3">
                                                            <Link scroll={false} href="#!" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                                                            ...
                                                            <Link scroll={false} href="#!" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Link>
                                                        </div>
                                                        <div className="d-flex justify-content-between">
                                                            <h6 className="fw-medium mb-0">$25,000 - $35,000</h6>
                                                ...
                                                <Card className="custom-card featured-jobs">
                                                    <Card.Body>
                                                        ...
                                                        <div className="d-flex flex-wrap gap-2 mb-3">
                                                            ...
                                                            <div className="ms-2">
                                                                <h5 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!"> React Developer</Link></h5>
                                                                <Link scroll={false} href="#!"><i className="bi bi-building"></i> Infratech PVT LTD</Link>
                                                            </div>
                                                        </div> 
                                                        <div className="popular-tags mb-3">
                                                            <Link scroll={false} href="#!" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                                                ...
                                                <Card className="custom-card featured-jobs">
                                                    <Card.Body>
                                                        ...
                                                        <div className="d-flex flex-wrap gap-2 mb-3">
                                                            ...
                                                            <div className="ms-2">
                                                                <h5 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!"> Vuejs Developer</Link></h5>
                                                                <Link scroll={false} href="#!">G Technical Solutions</Link>
                                                            </div>
                                                        </div> 
                                                        <div className="popular-tags mb-3">
                                                            <Link scroll={false} href="#!" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                                                ...
                                                <Card className="custom-card featured-jobs">
                                                    <Card.Body>
                                                        ...
                                                        <div className="d-flex flex-wrap gap-2 mb-3">
                                                            ...
                                                            <div className="ms-2">
                                                                <h5 className="fw-medium mb-0 d-flex align-items-center"><Link scroll={false} href="#!"> Wordpress Developer</Link></h5>
                                                                <Link scroll={false} href="#!">Hardware Private Solutions</Link>
                                                            </div>
                                                        </div> 
                                                        <div className="popular-tags mb-3">
                                                            <Link scroll={false} href="#!" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                    ...
                    <Col xl={4}>
                        <Card className="custom-card">
                            ...
                            <Card.Body>
                                <Row className="gy-3">
                                    <Col sm={6} xxl={6} xl={12}>
                                        <p className="fs-14 mb-4 d-flex align-items-center">
                                ...
                                <ListGroup className="list-group list-group-flush">
                                    <ListGroup.Item className="mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <p className="fw-medium fs-13 mb-1"><Link scroll={false} href="#!"> React Lead Developer</Link></p>
                                    ...
                                    <ListGroup.Item className="mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <p className="fw-medium fs-13 mb-1"><Link scroll={false} href="#!"> HTML Developer - Fresher</Link></p>
                                                <p className="mb-0 me-3"><i className="bi bi-building text-muted"></i>  Spruko Technologies PRIVATE LIMITED</p>
                                            </div>
                                        </div>
                                    </ListGroup.Item>
                                    <ListGroup.Item className="mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <p className="fw-medium fs-13 mb-1"><Link scroll={false} href="#!"> Wordpress Developer - Remote</Link></p>
                                    ...
                                    <li className="list-group-item">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <p className="fw-medium fs-13 mb-1"><Link scroll={false} href="#!"> Vuejs Frontend Developer</Link></p>
                                ...
                                <ListGroup className="list-group-flush">
                                    <ListGroup.Item className="mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <p className="fw-medium fs-14 mb-1"><Link scroll={false} href="#!">Infratech PVT LTD</Link></p>
                                    ...
                                    <ListGroup.Item className="mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <p className="fw-medium fs-14 mb-1"><Link scroll={false} href="#!">Spruko Technologies PRIVATE LIMITED</Link></p>
                                    ...
                                    <ListGroup.Item className="mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <p className="fw-medium fs-14 mb-1"><Link scroll={false} href="#!">Hardware Private Solutions </Link></p>
                                    ...
                                    <ListGroup.Item className="mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-3 flex-grow-1">
                                                <p className="fw-medium fs-14 mb-1"><Link scroll={false} href="#!"> G Technical Solutions</Link></p>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                <div className="">
                                    <h5 className="fw-medium mb-3">Get Latest Job Alerts</h5>
