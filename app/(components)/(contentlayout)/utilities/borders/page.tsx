...
return (
    <Fragment>
                {/* Page Header */}
                    <Seo title={"Borders"} />
                    <Pageheader Heading="Borders" Pages={[{title:"Utilities", active:true},{title:"Borders", active:false}]} />
                {/* Page Header Close */}

                {/* Start:: row-1 */}
                <Row>
                    <Col xl={12}>
                        <ShowCode title="Borders" customCardClass="custom-card" customCardBodyClass="" code={border1}>
                    ...
                    <Col xl={12}>
                        <ShowCode title="Remove borders" customCardClass="custom-card" customCardBodyClass="" code={border2}>
                ...
                <Row>
                    <Col xl={12}>
                        <ShowCode title="Border Widths" customCardClass="custom-card" customCardBodyClass="" code={border3}>
                    ...
                    <Col xl={12}>
                        <ShowCode title="Border colors" customCardClass="custom-card" customCardBodyClass="" code={border4}>
                ...
                <Row>
                    <Col xl={12}>
                        <ShowCode title="Border color Styling" customCardClass="custom-card" customCardBodyClass="" code={border5}>
                            <div className="mb-4">
                    ...
                    <Col xl={12}>
                        <ShowCode title="Border with opacity" customCardClass="custom-card" customCardBodyClass="" code={border6}>
                ...
                <Row>
                    <Col xl={12}>
                        <ShowCode title="Border Radius" customCardClass="custom-card" customCardBodyClass="" code={border7}>
                    ...
                    <Col xl={12}>
                        <ShowCode title="Sizes" customCardClass="custom-card" customCardBodyClass="" code={border8}>
