...
return (
    <Fragment>
                  {/* Page Header */}
                    ...
                    <Pageheader Heading="Additional Content" Pages={[{title:"Utilities", active:true},{title:"Additional Content", active:false}]} />
                  {/* Page Header Close */}
                            ...
                            <Row>
                                ...
                                <Col xl={12}>
                                    <Card className="custom-card">
                                        ...
                                        <Card.Body>
                                            <div className="mx-auto" style={{ width: "200px", padding: "10px", borderRadius: "4px;", backgroundColor: "#563d7c26" }}>
                                                Centered element
                                            </div>
                                        </Card.Body>
                                    </Card>
                                    ...
                                    <div style={{ height: "100px", backgroundColor: "rgba(255,0,0,0.1)" }}
                                     className="d-flex">
                                        <div className="h-25 d-inline-block"
                                            style={{width: "120px", backgroundColor: "rgba(0,0,255,.1)",padding:"10px;"}}>Height 25%
                                        </div>
                            ...
                            <Row>
                                ...
                                <Col xl={12}>
                                    <Card className="custom-card">
                                        ...
                                        <Card.Body>
                                            <p><a href="#!" className="pe-none" tabIndex={-1} aria-disabled="false"><code className="text-primary fw-medium">This link</code></a>
                                                can
                                                not be clicked.
                                            </p>
                                            <p><a href="#!" className="pe-auto"><code className="text-primary fw-medium">This link</code></a> can be clicked (this is default
                                                behavior).
                                            </p>
                                            <p className="pe-none mb-0"><a href="#!" tabIndex={-1} aria-disabled="false"><code>This link</code></a>
                                                can
