...
return (
    <Fragment>
                {/* Page Header */}
                    <Seo title={"Inputs"} />
                    <Pageheader Heading="Inputs" Pages={[{title:"Forms", active:true},{title:"Form Elements", active:true},{title:"Inputs", active:false}]} />
                {/* Page Header Close */}
                            ...
                            <ShowCode title="Input Types" customCardClass="custom-card" customCardBodyClass="" code={input1}>
                                <div className="row gy-4">
                                    <Col xl={4} lg={6} md={6} sm={12}>
                                        <Form.Label htmlFor="input-label"  className="mb-2">Basic Input:</Form.Label>
