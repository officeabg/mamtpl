"use client"
import { radio1, radio10, radio11, radio12, radio13, radio14, radio15, radio16, radio17, radio18, radio19, radio2, radio20, radio21, radio22, radio23, radio24, radio3, radio4, radio5, radio6, radio7, radio8, radio9 } from "@/shared/data/prism/forms-prism";
...
return (
    <Fragment>
                 {/* Page Header */}
                    ...
                    <Pageheader Heading="Checks & Radios" Pages={[{title:"Forms", active:true},{title:"Form Elements", active:true},{title:"Checks & Radios", active:false}]} />
                 {/* Page Header Close */}
                    ...
                    <Row>
                        ...
                        <ShowCode title="Checkbox Sizes" customCardClass="custom-card" customCardBodyClass="d-sm-flex align-items-center justify-content-between" code={radio7}>
                        ...
                        <Col xxl={12} xl={12} lg={12} md={12} sm={12}>
                            <ShowCode title="Radio Sizes" customCardClass="custom-card" customCardBodyClass="d-sm-flex align-items-center justify-content-between" code={radio8}>
                        ...
                        <Col xxl={12} xl={12} lg={12} md={12} sm={12}>
                            <ShowCode title="Switch Sizes" customCardClass="custom-card" customCardBodyClass="d-sm-flex align-item-center justify-content-between" code={radio9}>
                    ...
                    <Row>
                        <Col xl={6} lg={12} md={12} sm={12}>
                            <ShowCode title="Inline" customCardClass="custom-card" customCardBodyClass="" code={radio10}>
                                ...
                                <ShowCode title="Without labels" customCardClass="custom-card" customCardBodyClass="" code={radio11}>
                        ...
                        <Col xl={3} lg={12} md={12} sm={12}>
                            <ShowCode title="Reverse" customCardClass="custom-card" customCardBodyClass="" code={radio12}>
                        ...
                        <Col xl={3} lg={12} md={12} sm={12}>
                            <ShowCode title="Outlined styles" customCardClass="custom-card" customCardBodyClass="" code={radio13}>
                                ...
                                <Button variant='secondary' className=" mb-3">Checked</Button><br />
                                <Form.Check type="radio" className="btn-check" name="options-outlined" id="success-outlined"
                                    defaultChecked />
                                <Button variant='success' className="m-1">Checked success
                                    radio</Button>
                    ...
                    <Row>
                        <Col xl={6} lg={12} md={12} sm={12}>
                            <ShowCode title="Radio toggle buttons" customCardClass="custom-card" customCardBodyClass="" code={radio14}>
                        ...
                        <Col xl={6} lg={12} md={12} sm={12}>
                            <ShowCode title="Checkbox toggle buttons" customCardClass="custom-card" customCardBodyClass="" code={radio15}>
                    ...
                    <div className="row row-cols-12">
                        <Col md={6} lg={6} className="col col-xl">
                            <ShowCode title="Colored Checkboxes" customCardClass="custom-card" customCardBodyClass="" code={radio16}>
                                {Checkdata1.map((idx) => (
                        ...
                        <Col md={6} lg={6} className="col col-xl">
                            <ShowCode title="Outline Checkboxes" customCardClass="custom-card" customCardBodyClass="" code={radio17}>
                                {Checkdata1.map((idx) => (
                                    <div className={`form-check ${idx.class1}`} key={Math.random()}>
                        ...
                        <Col md={12}  className="col col-lg col-xl">
                            <ShowCode title="Colored Radios" customCardClass="custom-card" customCardBodyClass="" code={radio18}>
                                {Checkdata1.map((idx) => (
                                    <div className={`form-check ${idx.class1}`} key={Math.random()}>
                        ...
                        <Col sm={6} className="col col-lg">
                            <ShowCode title="Outline Radios" customCardClass="custom-card" customCardBodyClass="" code={radio19}>
                                {Checkdata1.map((idx) => (
                                    <div className={`form-check ${idx.class1}`} key={Math.random()}>
                                        <input id={idx.id} className={`form-check-input form-checked-outline form-checked-${idx.class2}`}
                                            type="radio" defaultChecked />
                        ...
                        <div className="col col-sm-6 col-lg">
                            <ShowCode title="Switches Colors" customCardClass="custom-card" customCardBodyClass="" code={radio20}>
                                {Checkdata1.map((idx) => (
                    ...
                    <Row>
                        ...
                        <ShowCode title="Toggle Switches Style-1" customCardClass="custom-card" customCardBodyClass="" code={radio21}>
                        ...
                        <Col xl={12} lg={12} md={12} sm={12}>
                            <ShowCode title="Toggle Switches Style-2" customCardClass="custom-card" customCardBodyClass="" code={radio22}>
                    ...
                    <Row>
                        <Col xl={12} lg={12} md={12} sm={12}>
                            <ShowCode title="Toggle Switch-1 Sizes" customCardClass="custom-card" customCardBodyClass="" code={radio23}>
                        ...
                        <Col xl={12} lg={12} md={12} sm={12}>
                            <ShowCode title="Toggle Switch-2 Sizes" customCardClass="custom-card" customCardBodyClass="" code={radio24}>
