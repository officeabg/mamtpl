"use client"
import { inputgroup1, inputgroup10, inputgroup11, inputgroup2, inputgroup3, inputgroup4, inputgroup5, inputgroup6, inputgroup7, inputgroup8, inputgroup9 } from "@/shared/data/prism/forms-prism";
...
<Fragment>
                    {/* Page Header */}
                        ...
                        <Pageheader Heading="Input Group" Pages={[{title:"Forms", active:true},{title:"Form Elements", active:true},{title:"Input Group", active:false}]} />
                    {/* Page Header Close */}
                    ...
                    <Row>
                        <Col xl={12}>
                            <Row>
                                <Col xl={12}>
                                    <ShowCode title="Multiple inputs" customCardClass="custom-card" customCardBodyClass="" code={inputgroup2}>
                                        <InputGroup>
                                ...
                                <Col xl={12}>
                                    <ShowCode title="Checkboxes and radios" customCardClass="custom-card" customCardBodyClass="" code={inputgroup3}>
                                            <InputGroup className="mb-3">
                                                <InputGroup.Text className="">
                                ...
                                <Col xl={12}>
                                    <ShowCode title="Multiple addons" customCardClass="custom-card" customCardBodyClass="" code={inputgroup4}>
                                        <InputGroup className="mb-3">
                                            <InputGroup.Text className="">
                                                <Form.Check className="mt-0" type="checkbox" value=""
                                                    aria-label="Checkbox for following text input" />
                                ...
                                <Col xl={12}>
                                <ShowCode title="Segmented buttons" customCardClass="custom-card" customCardBodyClass="" code={inputgroup5}>
                                        <InputGroup className="mb-3">
                                ...
                                <Col xl={12}>
                                <ShowCode title="Custom select" customCardClass="custom-card" customCardBodyClass="" code={inputgroup6}>
                                    <InputGroup className="mb-3">
                        ...
                        <Col xl={12}>
                            <Row>
                                <Col xl={12}>
                                    <ShowCode title="Sizing" customCardClass="custom-card" customCardBodyClass="" code={inputgroup7}>
                                ...
                                <Col xl={12}>
                                    <ShowCode title="Buttons addons" customCardClass="custom-card" customCardBodyClass="" code={inputgroup8}>
                                        <InputGroup className="mb-3">
                                ...
                                <Col xl={12}>
                                    <ShowCode title="Buttons with dropdowns" customCardClass="custom-card" customCardBodyClass="" code={inputgroup9}>
                                            <InputGroup className="mb-3">
                                                <Dropdown>
                                ...
                                <Col xl={12}>
                                <ShowCode title="Custom file input" customCardClass="custom-card" customCardBodyClass="" code={inputgroup10}>
                                    <InputGroup className="mb-3">
