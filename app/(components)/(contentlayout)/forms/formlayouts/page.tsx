...
<Fragment>
                    {/* Page Header */}
                        ...
                        <Pageheader Heading="Form Layouts" Pages={[{title:"Forms", active:true},{title:"Form Layouts", active:false}]} />
                    {/* Page Header Close */}
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title=" Vertical Forms with icon" customCardClass="custom-card" customCardBodyClass="" code={layout3}>
                                    <div className="mb-3">
                        ...
                        <Col xl={12}>
                            <ShowCode title="Horizontal form With Icons" customCardClass="custom-card" customCardBodyClass="" code={layout4}>
                                    <Form>
                                        <Row className="mb-3">
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Inline forms" customCardClass="custom-card" customCardBodyClass="" code={layout5}>
                        ...
                        <Col xl={12}>
                            <ShowCode title="Column sizing" customCardClass="custom-card" customCardBodyClass="" code={layout6}>
                                <Row className="g-3">
                                    <Col sm={7} className="">
                    ...
                    <Row>
                        <Col xl={12}>
                            <ShowCode title="Utilities" customCardClass="custom-card" customCardBodyClass="" code={layout7}>
                                <div className="mb-3">
                        ...
                        <Col xl={12}>
                                <ShowCode title="Horizontal form label sizing" customCardClass="custom-card" customCardBodyClass="" code={layout8}>
                                    <Row className="mb-3">
