"use client"
import { validation1, validation2, validation3, validation4, validation5 } from "@/shared/data/prism/forms-prism";
import React, { Fragment, useState } from "react";
import { Button,  Card,  Col, Form, InputGroup, Row } from "react-bootstrap";
import * as formik from "formik";
import * as yup from "yup";
import ShowCode from "@/shared/layout-components/showcode/showcode";
import Reacthookform from "@/shared/data/forms/validationdata";
...
<Fragment>
                    {/* Page Header */}
                        ...
                        <Pageheader Heading="Validation" Pages={[{title:"Forms", active:true},{title:"Validation", active:false}]} />
                    {/* Page Header Close */}
                                ...
                                <Col xl={12}>
                                    <ShowCode title="Server side Validation" customCardClass="custom-card" customCardBodyClass="" code={validation3}>
                                        <Form className="row g-3">
                                            ...
                                            <div className="col-12">
                                                <Button variant="" className="btn btn-primary" type="submit">Submit
                                                    form</Button>
                                            </div>
                                        </Form>
                                    </ShowCode>
